...
class _TestInfo(object):
    ...
    def print_report(self, stream):
        ...
        The informations are printed in XML format to the
        supplied stream.
        """
        stream.write(
...
class _XMLTestResult(unittest.TestResult):
    ...
    def print_report(self, stream, time_taken, out, err):
        """Print the XML report to the supplied stream.
...
class XMLTestRunnerTest(unittest.TestCase):
    ...
    def _try_test_run(self, test_class, expected):
        """Run the test suite against the supplied test class.

        Run and compare the XML result against the expected XML string.
        Fail if the expected string doesn't match the actual string.
        All time attributes in the expected string should have the
        value "0.000". All error and failure messages are reduced to
        "Foobar".
        """
    ...
    def test_no_tests(self):
        """Run no test regression test.

        Check whether a test run without any tests matches a previous
        run.
        """
...
""")
    ...
    def test_success(self):
        """Run success regression test.

        Check whether a test run with a successful test matches a
        previous run.
        """
        class TestTest(unittest.TestCase):
            def test_foo(self):
...
""")
    ...
    def test_failure(self):
        """Run failure regression test.

        Check whether a test run with a failing test  matches a
        previous run.
        """
        class TestTest(unittest.TestCase):
            def test_foo(self):
...
""")
    ...
    def test_error(self):
        """Run error regression test.

        Check whether a test run with a erroneous test matches a
        previous run.
        """
        class TestTest(unittest.TestCase):
            def test_foo(self):
...
""")
    ...
    def test_stdout_capture(self):
        """Run stdout regression test.

        Check whether a test run with output to stdout matches a
        previous run.
        """
        class TestTest(unittest.TestCase):
            def test_foo(self):
...
""")
    ...
    def test_stderr_capture(self):
        """Run stderr regression test.

        Check whether a test run with output to stderr matches a
        previous run.
        """
        class TestTest(unittest.TestCase):
            def test_foo(self):
...
""")
    ...
    def test_unittests_changing_stdout(self):
        """Test XMLTestRunner when stdout has been changed.

        Check wether the XMLTestRunner recovers gracefully from unit
        tests that change stdout, but don't change it back properly.
        """
        class TestTest(unittest.TestCase):
            def test_foo(self):
    ...
    def test_unittests_changing_stderr(self):
        """Test XMLTestRunner when stderr has been changed.

        Check whether the XMLTestRunner recovers gracefully from unit
        tests that change stderr, but don't change it back properly.
        """
        class TestTest(unittest.TestCase):
            def test_foo(self):
